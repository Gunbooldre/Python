# Author- Dias Muratabayev
#At firts we shoud import tkinter and numpy
#Because of tkinter we can create our mini game 
from tkinter import *
import numpy as np

size_of_board = 800 # size of board 
number_of_dots = 6 # number of dots
symbol_size = (size_of_board / 3 - size_of_board / 8) / 2 #symbol size
symbol_thickness = 50 #thickness
dot_color = '#7BC043' #giving a color to dot
player1_color = '#0492CF' # color of first player
player1_color_light = '#67B0CF' # color of first player light
player2_color = '#EE4035'# color of second color 
player2_color_light = '#EE7E77' # color of second light
Green_color = '#7BC043'  #Green color XD
dot_width = 0.25*size_of_board/number_of_dots # width  of dots
edge_width = 0.1*size_of_board/number_of_dots # edge of width
distance_between_dots = size_of_board / (number_of_dots) # distance between dots
