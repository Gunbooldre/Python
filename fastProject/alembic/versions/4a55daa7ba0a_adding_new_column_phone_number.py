"""adding new column phone number

Revision ID: 4a55daa7ba0a
Revises: c439992c5f18
Create Date: 2024-11-25 15:06:35.369263
...
revision: str = "4a55daa7ba0a"
down_revision: Union[str, None] = "c439992c5f18"
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "ship_name", sa.VARCHAR(length=40), autoincrement=False, nullable=True
        ),
        sa.Column(
            "ship_address", sa.VARCHAR(length=60), autoincrement=False, nullable=True
        ),
        sa.Column(
            "ship_city", sa.VARCHAR(length=15), autoincrement=False, nullable=True
        ),
        sa.Column(
            "ship_region", sa.VARCHAR(length=15), autoincrement=False, nullable=True
        ),
        sa.Column(
            "ship_postal_code",
        ...
        sa.Column(
            "ship_country", sa.VARCHAR(length=15), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["customer_id"], ["customers.customer_id"], name="fk_orders_customers"
        ),
        sa.ForeignKeyConstraint(
            ["employee_id"], ["employees.employee_id"], name="fk_orders_employees"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "category_name", sa.VARCHAR(length=15), autoincrement=False, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "company_name", sa.VARCHAR(length=40), autoincrement=False, nullable=False
        ),
        sa.Column(
            "contact_name", sa.VARCHAR(length=30), autoincrement=False, nullable=True
        ),
        sa.Column(
            "contact_title", sa.VARCHAR(length=30), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["order_id"], ["orders.order_id"], name="fk_order_details_orders"
        ),
        sa.ForeignKeyConstraint(
            ["product_id"], ["products.product_id"], name="fk_order_details_products"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "territory_id", sa.VARCHAR(length=20), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["employee_id"],
        ...
        sa.PrimaryKeyConstraint(
            "employee_id", "territory_id", name="pk_employee_territories"
        ),
    )
    op.create_table(
        "employees",
        sa.Column("employee_id", sa.SMALLINT(), autoincrement=False, nullable=False),
        sa.Column(
            "last_name", sa.VARCHAR(length=20), autoincrement=False, nullable=False
        ),
        sa.Column(
            "first_name", sa.VARCHAR(length=10), autoincrement=False, nullable=False
        ),
        ...
        sa.Column("country", sa.VARCHAR(length=15), autoincrement=False, nullable=True),
        sa.Column(
            "home_phone", sa.VARCHAR(length=24), autoincrement=False, nullable=True
        ),
        sa.Column(
            "extension", sa.VARCHAR(length=4), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "photo_path", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["reports_to"], ["employees.employee_id"], name="fk_employees_employees"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "territory_description", sa.NullType(), autoincrement=False, nullable=False
        ),
        sa.Column("region_id", sa.SMALLINT(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["region_id"], ["region.region_id"], name="fk_territories_region"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "state_name", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        sa.Column(
            "state_abbr", sa.VARCHAR(length=2), autoincrement=False, nullable=True
        ),
        sa.Column(
            "state_region", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("customer_id", sa.NullType(), autoincrement=False, nullable=False),
        sa.Column(
            "customer_type_id", sa.NullType(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["customer_id"],
        ...
        sa.PrimaryKeyConstraint(
            "customer_id", "customer_type_id", name="pk_customer_customer_demo"
        ),
    )
    op.create_table(
        "shippers",
    ...
    op.create_table(
        ...
        sa.Column("product_id", sa.SMALLINT(), autoincrement=False, nullable=False),
        sa.Column(
            "product_name", sa.VARCHAR(length=40), autoincrement=False, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["categories.category_id"], name="fk_products_categories"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("region_id", sa.SMALLINT(), autoincrement=False, nullable=False),
        sa.Column(
            "region_description", sa.NullType(), autoincrement=False, nullable=False
        ),
